      ...
      <div className="my-8 flex flex-col gap-5">
        ...
        <section className="mt-4">
          <div className="container p-8 bg-[#F6E9E9] w-3/4 mx-auto max-md:w-11/12">
            <div className="w-full flex flex-col gap-3">
              ...
              <h4 className="mt-3 font-medium text-xl text-gray-900">
        ...
        <section className="mt-4">
          <div className="container p-8 bg-[#DBECF1] w-3/4 mx-auto max-md:w-11/12">
            <div className="w-full flex flex-col gap-3">
              <h4 className="mt-3 font-semibold text-2xl text-gray-900">
              ...
              <h4 className="mt-3 font-medium text-2xl text-gray-900">
